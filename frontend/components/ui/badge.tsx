  ...
  "inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        success: "cylvy-badge-success border border-[rgb(var(--status-success-fg))]/20",
        warning: "cylvy-badge-warning border border-[rgb(var(--status-warning-fg))]/20", 
        error: "cylvy-badge-error border border-[rgb(var(--status-error-fg))]/20",
        info: "cylvy-badge-info border border-[rgb(var(--status-info-fg))]/20",
